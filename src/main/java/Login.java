...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("XYZ PVT LIMITED");
        ...
        t2.setFont(new java.awt.Font("Segoe UI Black", 0, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String p = new String(passwordChars); // Convert the password to a String
        JLabel msg = new JLabel(); // Add this line to declare the variable msg
        try {
